...
<head>
	...
	<title>JuegosOnline | <?php echo $titulo; ?></title>
	...
	<nav class="navbar navbar-default" role="navigation">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo base_panel; ?>">Juegos<strong>Online</strong></a>
			</div>
	
			<!-- Collect the nav links, forms, and other content for toggling -->
			<div class="collapse navbar-collapse navbar-ex1-collapse">
				<ul class="nav navbar-nav navbar-right">
					<li class="<?php if($seccion_menu == 'seccion_usuarios'){ echo 'active'; } ?>"><a href="<?php echo base_url(); ?>admin/usuarios">Usuarios</a></li>
					<li class="dropdown <?php if($seccion_menu == 'seccion_juegos'){ echo 'active'; } ?>">
						<a href="" class="dropdown-toggle" data-toggle="dropdown">Juegos <b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="<?php echo base_url(); ?>admin/juegos">Juegos</a></li>
